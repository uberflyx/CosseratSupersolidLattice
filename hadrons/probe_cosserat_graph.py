...
TESTS = [
    ...
    ("phi(1020)",        1019.46, dict(B=0, I=0, I3=0, J=1, P=-1)),
    ...
    ("eta(1295)",        1294.0,  dict(B=0, I=0, I3=0, J=0, P=-1, level=2)),
    ...
    ("eta(1405)",        1408.7,  dict(B=0, I=0, I3=0, J=0, P=-1, level=2)),
    ...
    ("eta(1475)",        1476.0,  dict(B=0, I=0, I3=0, J=0, P=-1, level=2)),
    ("f_0(1500)",        1522.0,  dict(B=0, I=0, I3=0, J=0, P=+1)),
    ("f_2'(1525)",       1517.3,  dict(B=0, I=0, I3=0, J=2, P=+1)),
    ("eta_2(1645)",      1617.0,  dict(B=0, I=0, I3=0, J=2, P=-1)),
    ("omega(1650)",      1670.0,  dict(B=0, I=0, I3=0, J=1, P=-1)),
    ...
    ("rho(1700)",        1720.0,  dict(B=0, I=1, I3=0, J=1, P=-1)),
    ...
    ("f_2(1950)",        1936.0,  dict(B=0, I=0, I3=0, J=2, P=+1)),
    ...
    ("N(1650)",          1650.0,  dict(B=1, I=0.5, I3=+0.5, J=0.5, P=-1, level=2)),
    ...
    ("Lambda(1670)",     1674.0,  dict(B=1, S=-1, I=0, I3=0, J=0.5, P=-1, level=2)),
    ("Lambda(1690)",     1690.0,  dict(B=1, S=-1, I=0, I3=0, J=1.5, P=-1, level=2)),
