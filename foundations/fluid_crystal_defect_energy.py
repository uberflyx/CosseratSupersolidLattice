...
print("  LOG CONVENTION: knot_kibble_zurek_abundance.py tabulates with the")
print("  core-scale reading ln(R/xi)=1 (frozen loop ~1e2 TeV at b~1e5); the")
print("  isolated-loop reading ln(b)~10 used here raises that tenfold and")
print("  shifts the Omega-matching b* by ~sqrt(ln) ~ 3, inside the Zurek band.")
print("  Under either convention the frozen loops are far too heavy and")
print("  collisional for the SIDM window; the conclusion is unchanged.")
