...
print("  - separating the weak-vertex drive from standard laser-assisted final-state")
print("    (electron) effects, which scale as alpha*n and change the spectrum shape")
print("    rather than the nuclear rate -- the signatures differ and can be split;")
print("  - the exact vertex matrix element for a given transition.")
