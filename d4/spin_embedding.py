...
if ok:
    ...
    print("  group. Colour SU(3) sits inside Spin(8) (the stacking triplet).")
    print("  Weak SU(2)_L is the left factor of the chiral so(4) built on the")
    print("  fourth-plane pair: one Cartan leg inside Spin(8), the other the")
    print("  interface U(1) toward Spin(10), so its ladder straddles 8_s and")
    print("  8_c rather than sitting inside Spin(8). The completing U(1) to E6")
    print("  is the condensate. The explicit map, which defect fills which")
    print("  weight of 8_s + 8_c, is supplied and verified in weight_map_16.py.")
else:
